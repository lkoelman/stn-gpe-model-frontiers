"""
Analysis of ion channels implemented as NEURON mechanism.

This module was copied from PyNeuron-Toolbox with minor changes:
Alex H Williams. (2014). PyNeuron-Toolbox. GitHub Repository.
https://github.com/ahwillia/PyNeuron-Toolbox DOI:10.5281/zenodo.12576

@author     Alex H Williams
@date       2014

@ref        https://github.com/ahwillia/PyNeuron-Toolbox
@ref        DOI:10.5281/zenodo.12576
"""
...
def ivcurve(mechanism_name, i_type, vmin=-100, vmax=100, deltav=1, transient_time=50, test_time=50, rs=1, vinit=-665):
    ...
    for test_v in result_v:
        ...
        # Simulate for transient + test period
...
if __name__ == '__main__':
    """
    Test iv curve for NEURON built-in HH mechanism
    """
