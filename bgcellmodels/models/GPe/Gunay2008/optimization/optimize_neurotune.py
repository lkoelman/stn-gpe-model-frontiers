...
class GpeController(object):
    ...
    def __init__(
        ...
        # instantiate cell
        self.model = gunay.GpeProtoCellType.model(**cell_params)
    ...
    def set_base_parameters(self):
        ...
        self.target_sections = {'soma': self.soma, 'ais': self.ais}
...
def optimize(export_locals=False):
    ...
    opt_param_defaults = OrderedDict([
        # soma
        ('soma_gmax_NaF',    0.035000),
        ('soma_gmax_NaP',    0.000102),
        ('soma_gmax_Kv2',    0.000100),
        ('soma_gmax_Kv3',    0.001000),
        ('soma_gmax_Kv4f',   0.002000),
        ('soma_gmax_Kv4s',   0.003000),
        ('soma_gmax_KCNQ',   0.000200),
        ('soma_gmax_SK',     0.006400),
        ('soma_gmax_CaHVA',  0.000030),
        ('soma_gmax_HCN',    0.000100),
        ('soma_gmax_HCN2',   0.000250),
        # axon
        ('ais_gmax_NaF',     0.500000),
        ('ais_gmax_NaP',     0.004000),
        # ('ais_gmax_Kv2',     0.064000),
        # ('ais_gmax_Kv3',     0.128000),
        # ('ais_gmax_Kv4f',    0.160000),
        # ('ais_gmax_Kv4s',    0.240000),
        # ('ais_gmax_KCNQ',    0.000040),
    ])
    ...
    opt_param_seeds = [
        ...
        # [1.088976095416787, 0.0102, 0.009997311369070006, 0.07472870427860101, 0.13623172224458147, 0.21694343549992162, 0.019683786548542716, 0.215855161863178, 0.00040706088365998237, 0.009355204839748313, 0.000301543803557004, 15.836359620045412, 0.4, 4.0885947477682105, 3.007863143713057, 5.964701100254942, 5.971654624191065, 0.002689233205754577]
    ]
