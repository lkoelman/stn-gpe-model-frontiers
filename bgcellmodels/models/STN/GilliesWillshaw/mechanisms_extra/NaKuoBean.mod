...
NEURON {
  SUFFIX NaKB : NOTE: change Natrans->Na and gbar->gna for interoperability with default Na mechanism
...
PARAMETER {
	...
	Coff = 4.5			(1/ms)		: inactivated -> closed transitions
	Oon = 4.0			(1/ms)		: open -> Ineg transition
	Ooff = 0.008		(1/ms)		: Ineg -> open transition

	: Transition rates between weakly/tightly bound states
	alpha = 20			(1/ms)		: activation
	beta = 3			(1/ms)		: deactivation
	gamma = 50			(1/ms)		: opening
	delta = 0.2			(1/ms)		: closing, greater than BEAN/KUO = 0.2
	...
	x1 = 40				(mV)								: Vdep of activation (alpha)
	x2 = -40			(mV)								: Vdep of deactivation (beta)
	x3 = 100			(mV)								: Vdep of opening (gamma)
	x4 = -25			(mV)								: Vdep of closing (delta)
